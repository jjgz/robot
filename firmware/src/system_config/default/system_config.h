...
#define DRV_TMR_PERIPHERAL_ID_IDX3          TMR_ID_2
#define DRV_TMR_INTERRUPT_SOURCE_IDX3       INT_SOURCE_TIMER_2
#define DRV_TMR_INTERRUPT_VECTOR_IDX3       INT_VECTOR_T2
#define DRV_TMR_ISR_VECTOR_IDX3             _TIMER_2_VECTOR
